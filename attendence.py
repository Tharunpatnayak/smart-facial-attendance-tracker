...
class Attendance:
    def __init__(self, root):
        ...
        # First Image
        img = Image.open(r"C:\Face Recognition Software\5EERFPimg\a1.png") 
        ...
        # second Image
        img1= Image.open(r"C:\Face Recognition Software\5EERFPimg\a2.png") 
        ...
        #bg img
        img_path3 = r"C:\Face Recognition Software\5EERFPimg\bg.png"  
        ...
        img_path_left = r"C:\Face Recognition Software\5EERFPimg\sleft.png"
        ...
        deptLabel.grid(row=1, column=2, padx=4, pady=8)
    ...
    def update_data(self):
        if self.var_atten_id.get() == "":
            ...
            try:
                ...
                if self.var_atten_attendance.get() == "Absent":
                    # Remove from mydata
                    for i, row in enumerate(mydata):
                        if row[0] == self.var_atten_id.get():  # Match by Student ID
                            del mydata[i]
                            break
                    # Delete from Treeview
                    self.AttendanceReportTable.delete(selected)
                    messagebox.showinfo("Success", "Student record deleted due to Absent status", parent=self.root)
                    self.reset_data()
                else:
                    # Update the record if not Absent
                    updated_values = [
